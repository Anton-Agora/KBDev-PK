...
declare namespace RtmEvents {
  ...
  export interface RtmClientEvents {
     ...
     */
    /**
     *  Occurs when the user is kicked out of the current channel.
     */
    BannedByServer: () => void;
 ...
 * @noInheritDoc
 */
declare class RtmChannel extends EventEmitter<RtmEvents.RtmChannelEvents> {
  /** @zh-cn
   * @readonly
   * 频道实例的 ID。
   */
   ...
   *
   * @param items the items user wants to operate, each item must has unique key.
   * @param options Options for this metadata operation. See {@link RtmMetadataOptions}.
   */
  addChannelMetadata(
    items: RtmMetadataItem[],
...
declare class RtmClient extends EventEmitter<RtmEvents.RtmClientEvents> {
  ...
  /** @zh-cn
   * 创建一个 {@link RtmMetadataItem} 实例。
   */
  /**
   * Creates an {@link RtmMetadataItem} instance.
   */
   ...
   * @param uid The uid of the user logging in the Agora RTM system.
   */
...
export type { LocalInvitation, RemoteInvitation, RtmChannel, RtmClient, RtmEvents, RtmMessage, RtmMetadata, RtmMetadataItem, RtmRawMessage, RtmStatusCode, RtmTextMessage };
